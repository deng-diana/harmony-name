...
export const COMMON_SURNAMES: CommonSurname[] = [
  ...
  { chinese: '陈', english: 'Chén', wuxing: 'Fire', meaning: 'A classical Chinese surname, associated with the ancient state of Chen' },
  { chinese: '程', english: 'Chéng', wuxing: 'Fire', meaning: 'A classical Chinese surname meaning order and progress' },
  { chinese: '池', english: 'Chí', wuxing: 'Water', meaning: 'A classical Chinese surname evoking a serene pool' },
  { chinese: '楚', english: 'Chǔ', wuxing: 'Wood', meaning: 'Clear' },
  { chinese: '戴', english: 'Dài', wuxing: 'Fire', meaning: 'A classical Chinese surname meaning dignity and ceremony' },
  ...
  { chinese: '杜', english: 'Dù', wuxing: 'Wood', meaning: 'A classical Chinese surname, borne by the Tang poet Du Fu' },
  ...
  { chinese: '洪', english: 'Hóng', wuxing: 'Water', meaning: 'A classical Chinese surname evoking the grandeur of flowing water' },
  { chinese: '胡', english: 'Hú', wuxing: 'Earth', meaning: 'A classical Chinese surname of ancient lineage' },
  ...
  { chinese: '刘', english: 'Liú', wuxing: 'Metal', meaning: 'A classical Chinese surname, borne by the founders of the Han dynasty' },
  ...
  { chinese: '沈', english: 'Shěn', wuxing: 'Water', meaning: 'A classical Chinese surname, borne by the celebrated Ming painter Shen Zhou' },
