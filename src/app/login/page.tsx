      ...
      >
        <div className="mb-5">
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white border border-stone-200 rounded-xl outline-none focus:ring-2 focus:ring-stone-900 transition-all"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-stone-900 text-white py-4 rounded-xl font-bold hover:bg-stone-800 active:scale-[0.98] transition-all shadow-lg disabled:opacity-50"
        >
          {loading
            ? "Please wait..."
            : mode === "signin"
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border border-stone-200 bg-white py-3.5 rounded-xl font-medium text-stone-700 hover:bg-stone-50 active:scale-[0.98] transition-all disabled:opacity-50"
        >
